...
//	genie_(individu.getGenie()),
//	nom_(individu.getNom()) {
//	auto it = individu.getDonneesRelation().begin();
//	for (it; it != individu.getDonneesRelation().end(); it++) {
//		Individu* unIndividu = new Individu(*it->first);
//		setRelation(unIndividu,it->second);
//	
//	
//	}
//
...
map<Individu*, int>& Individu::getDonneesRelation()   { 
